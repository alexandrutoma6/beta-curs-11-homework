package org.beta.curs11.homework.ex2.managers;
...
public class PersonManager {
    ...
    public List<String> getNameList(List<Person> persons) {
    ...
    public Map<String, Integer> getNameToAge(List<Person> persons) {
    ...
    public List<Person> getPersonsOlderThan(Integer givenAge, List<Person> persons) {
    ...
    public Map<String, List<String>> getHairColorToName(List<Person> persons) {
    ...
    public  Map<Integer, List<Person>> getAgeToName(List<Person> persons) {
